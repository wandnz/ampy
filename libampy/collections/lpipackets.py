...
class LPIPackets(Collection):
    def __init__(self, colid, viewmanager, nntscconf):
        super(LPIPackets, self).__init__(colid, viewmanager, nntscconf)

        self.streamproperties = ['source', 'protocol', 'user', 'dir']
        self.groupproperties = ['source', 'protocol', 'user', 'dir']
    ...
    def create_group_description(self, properties):
        ...
        return "MONITOR %s PROTOCOL %s USER %s %s" % \
