...
back-end components of AMP. It serves as the intermediary between the
web interface (amp-web) and databases used to store the data for display:
the AMP site meta data database, the views database for storing website
related configuration, the events database and the measurement database
itself (nntsc).
